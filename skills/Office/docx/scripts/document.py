...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "Ticca", initials: str = "T"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "Ticca")
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "Ticca")
